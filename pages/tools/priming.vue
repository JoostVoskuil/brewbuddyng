<template>
  <div class="max-w-lg">
    <h1 class="text-2xl font-bold mb-6">{{ $t('tools.priming') }}</h1>
    <div class="space-y-4">
      ...
      <div v-if="result" class="border rounded-lg p-4 bg-muted/30 space-y-1">
        <p class="text-lg font-semibold">{{ result.sugarGrams }} g total sugar</p>
        <p class="text-sm text-muted-foreground">~{{ result.sugarPerBottle }} g per 330ml bottle</p>
